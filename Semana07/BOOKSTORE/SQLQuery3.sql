...
EXEC USP_VENTA 'Gustavo','LIB00999',10,4,@IDVENTA out, @ESTADO out;
PRINT 'IDVENTA: ' + CAST(ISNULL(@IDVENTA,0) AS VARCHAR(20));
PRINT 'ESTADO: ' + CAST(@ESTADO AS VARCHAR(20));
GO


SELECT * FROM PROMOCION;
SELECT * FROM CONTROL WHERE parametro='VENTA';
SELECT * FROM VENTA ORDER BY 1 DESC;
SELECT idpublicacion, stock 
FROM PUBLICACION WHERE idpublicacion='LIB00003';